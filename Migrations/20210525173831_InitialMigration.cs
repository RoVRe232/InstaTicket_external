        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SingerName = table.Column<string>(maxLength: 256, nullable: true),
                    FestivalEventId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Event", x => x.EventId);
                    table.ForeignKey(
                        name: "FK_Event_Event_FestivalEventId",
                        column: x => x.FestivalEventId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TicketId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TicketEventEventId = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickets_Customers_HolderId",
                        column: x => x.HolderId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tickets_Event_TicketEventEventId",
                        column: x => x.TicketEventEventId,
                        principalTable: "Event",
                        principalColumn: "EventId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Event_FestivalEventId",
                table: "Event",
                column: "FestivalEventId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_TicketEventEventId",
                table: "Tickets",
                column: "TicketEventEventId");
        }
